...
#            print("[!] Unexpected interference — kill NetworkManager/wpa_supplicant!")
    ...
    def __credentialPrint(self, wps_pin=None, wpa_psk=None, essid=None):
        print(f"[+] WPS PIN : '{colored(wps_pin, 'green')}'")  # pyright: ignore[reportUndefinedVariable]
        print(f"[+] Wifi Password : '{colored(wpa_psk, 'green')}'")  # pyright: ignore[reportUndefinedVariable]
        print(f"[+] Access point Name : '{colored(essid, 'green')}'")  # pyright: ignore[reportUndefinedVariable]
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        def truncateStr(s, length, postfix="…"):
            ...
            if result_width > length:
                ...
                # If the truncated string becomes shorter, add ellipsisrequired
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='modded by Mr. Cyb3rgh0st',
